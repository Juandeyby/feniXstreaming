 ...
 * @author USUARIO
 */
public class TrasmitirVideoEjemplo extends javax.swing.JFrame {
   ...
   int returnVal = Escoje.showOpenDialog(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrasmitirVideoEjemplo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrasmitirVideoEjemplo().setVisible(true);
            }
        });
    }
